        ...
        if (data.startsWith("DATE_")) {
            ...
            SendMessage message = SendMessage.builder()
                    ...
                    .text(String.format("""
                        ...
                        ⏰ *Как это работает:*
                        Ниже — промежутки времен. Ты должен выбрать любое время внутри доступного промежутка, когда ты можешь ПРИЙТИ к мастеру.
                        Процедура начнётся в это время и займёт нужную продолжительность.
